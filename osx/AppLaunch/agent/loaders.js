...
export function loadRenderSupport() {
  ...
  var renderSupport = {
    ...
    CGEventCreateScrollWheelEvent: new NativeFunction(
      resolveExport(null, "CGEventCreateScrollWheelEvent"),
      "pointer",
      ["pointer", "uint32", "uint32", "int32"],
    ),
    CGEventCreateScrollWheelEvent2: new NativeFunction(
      resolveExport(null, "CGEventCreateScrollWheelEvent"),
      "pointer",
      ["pointer", "uint32", "uint32", "int32", "int32"],
    ),
    CGEventSetDoubleValueField: new NativeFunction(
      resolveExport(null, "CGEventSetDoubleValueField"),
      "void",
      ["pointer", "uint32", "double"],
    ),
    CGEventSetIntegerValueField: new NativeFunction(
      resolveExport(null, "CGEventSetIntegerValueField"),
      "void",
    ...
    kCGScrollWheelEventDeltaAxis1: 0x30,
    kCGScrollWheelEventDeltaAxis2: 0x31,
    kCGScrollWheelEventDeltaAxis3: 0x32,
    kCGScrollWheelEventFixedPtDeltaAxis1: 0x94,
    kCGScrollWheelEventFixedPtDeltaAxis2: 0x95,
    kCGScrollWheelEventFixedPtDeltaAxis3: 0x96,
    kCGScrollWheelEventPointDeltaAxis1: 0x97,
    kCGScrollWheelEventPointDeltaAxis2: 0x98,
    kCGScrollWheelEventPointDeltaAxis3: 0x99,
    kCGScrollWheelEventInstantMouser: 0x33,
    kCGScrollWheelEventIsContinuous: 0x34,
    kCGScrollWheelEventScrollCount: 0x35,
    kCGScrollWheelEventScrollPhase: 0x36,
    kCGScrollWheelEventScrollCount2: 0x37,
    kCGScrollPhaseBegan: 1,
    kCGScrollPhaseStationary: 2,
    kCGScrollPhaseChanged: 3,
    kCGScrollPhaseEnded: 4,
    kCGScrollPhaseMayBegin: 5,
    kCGScrollPhaseNone: 0,
    kCGScrollWheelEventScrollUnitPixel: 0,
    kCGScrollWheelEventScrollUnitLine: 1,
    kCGScrollWheelEventScrollUnitPixelPoint: 2,
    kCGEventTargetProcessSwitch: 0x38,
    kZPixmap: 2,
  };
